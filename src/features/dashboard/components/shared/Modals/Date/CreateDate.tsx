...
import { CountryCreateRequest } from "@/features/dashboard/services/Controls/country.service.ts";
...
const CreateDate = ({
  ...
  const create = async (event: FormEvent) => {
    ...
    const { status, data } = await CountryCreateRequest(formData);
  ...
  return (
    <Modal
      title={t("workers.modals.create.title__1")}
