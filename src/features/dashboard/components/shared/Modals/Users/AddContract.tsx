...
import { addContract } from "@/features/dashboard/services/Users/addbalance.service.ts";
...
const AddContract = ({
  ...
  const create = async (event: FormEvent) => {
    ...
    const { status, data } = await addContract(formData, id);
  ...
  return (
    <Modal
      title={t("workers.modals.create.contract")}
      ...
      <form className={styles.form} onSubmit={create}>
        <div className={styles.form__inputs}>
          <div className={styles.dropzone}>
            <span>
              {t("workers.modals.create.inputs.full_name.label__contract")}
            </span>
